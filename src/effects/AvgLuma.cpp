...
#define Histogram_SampleRes 16 //[32:253] //-Adjust sample resolution (effects performance)
...
void AvgLumaEffect::RegisterTextures() {
	...
	TheTextureManager->InitTexture("TESR_HistogramLumaBuffer", &Textures.HistogramLumaTexture, &Textures.HistogramLumaSurface, TheRenderManager->width, TheRenderManager->height, D3DFMT_A16B16G16R16F);
	...
	TheTextureManager->InitTexture("TESR_HistogramBinBufferY", &Textures.HistogramBinTextureY, &Textures.HistogramBinSurfaceY, TheRenderManager->width / Histogram_SampleRes, TheRenderManager->height / Histogram_BinCount, D3DFMT_A32B32G32R32F);
	...
	TheShaderManager->CreateFrameVertex(TheRenderManager->width / Histogram_SampleRes, TheRenderManager->height / Histogram_BinCount, &Textures.HistogramBinBufferY);
...
void AvgLumaEffect::RenderAvgLumaBuffer(IDirect3DSurface9* RenderTarget, IDirect3DSurface9* RenderedSurface, IDirect3DSurface9* SourceBuffer) {
	...
	Render(Device, Textures.HistogramBinSurfaceY, Textures.HistogramBinSurfaceY, 3, false, NULL);
	...
	Render(Device, Textures.HistogramBinSurfaceXY, Textures.HistogramBinSurfaceXY, 4, false, NULL);
	...
	Render(Device, Textures.HistogramSurface, Textures.HistogramSurface, 5, false, NULL);
	...
	Render(Device, Textures.AvgLumaSurface, Textures.AvgLumaSurface, 6, false, NULL);
	...
	Render(Device, RenderTarget, RenderedSurface, 7, false, NULL);
}
...
void AvgLumaEffect::UpdateSettings() {
	Constants.BufferRes.x = (int)(TheRenderManager->height / Histogram_SampleRes);
	Constants.BufferRes.y = (int)(TheRenderManager->width / Histogram_SampleRes);
