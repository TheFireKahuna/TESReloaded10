...
{
	return ThisStdCall<UInt32, UInt32>(ADDR_GetRandomInt, (void*)GAME_RNG, uBound);
}
__forceinline SInt32 GetRandomIntInRange(SInt32 iMin, SInt32 iMax)
{
	return ThisStdCall<SInt32, SInt32>(ADDR_GetRandomInt, (void*)GAME_RNG, iMax - iMin) + iMin;
}
