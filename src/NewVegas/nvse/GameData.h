...
public:
	...
	{
		return ThisStdCall<bool>(0x4603B0, this, pForm);
	}
...
public:
	...
	{
		ThisStdCall(0x63C8F0, this, climate, immediate);
	}
...
public:
	...
	{
		ThisStdCall(0x6296D0, this, refr, currPos, outPos);
	}
};
...
public:
	...
	{
		return ThisStdCall<bool>(0x4572E0, this, posXY, result);
	}

	__forceinline void AddTempNode(NiAVObject *object, float lifetime)
	{
		ThisStdCall(0x458E20, this, object, lifetime);
	}
	...
	__forceinline void CreateTextureImage(const char *filePath, NiSourceTexture **outTexture, bool mustFindFile = 1, bool archiveOnly = 0)
	{
		...
		ThisStdCall(0x4568C0, this, filePath, outTexture, mustFindFile, archiveOnly);
	}
