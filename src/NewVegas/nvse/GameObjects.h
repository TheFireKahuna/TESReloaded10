...
public:
	...
	__forceinline float GetScale() {return ThisStdCall<float>(0x567400, this);}
	...
	{
		return ThisStdCall<bool>(0x573170, this, actionRef, arg2, arg3, arg4);
	}
};
...
public:
	...
	{
		ThisStdCall(0x88C650, this, objType, equipCount, itemExtraList, applyEnchantment, lockEquip, noMessage);
	}
	...
	{
		ThisStdCall(0x88C790, this, objType, unequipCount, itemExtraList, removeEnchantment, lockUnequip, noMessage);
	}
...
public:
	...
	void RefreshWornDTDR()
	{
		totalArmorDR = -1.0F;
		totalArmorDT = -1.0F;
		ThisStdCall(0x8D2110, this);
		ThisStdCall(0x8D22B0, this);
	}
};
...
public:
	...
	{
		return ThisStdCall<bool>(0x950110, this, toggleON);
	}
