...
struct BaseExtraList
{
	...
	{
		return ThisStdCall<BSExtraData*>(ADDR_AddExtraData, this, toAdd);
	}
	...
	{
		ThisStdCall(ADDR_RemoveExtraType, this, xType);
	}
	...
	{
		ThisStdCall(0x412490, this, sourceList, bCopyAndRemove);
	}
...
public:
	...
	{
		ThisStdCall(0x84A690, g_BGSSaveLoadGame, this, modFlag, 0);
	}
...
struct Condition
{
	...
	{
		return ThisStdCall<bool>(0x681600, this, runOnRef, arg2, result);
	}
};
...
struct ConditionList : tList<Condition>
{
	...
	{
		return ThisStdCall<bool>(0x680C60, this, runOnRef, arg2, result, arg4);
	}
};
...
public:
	...
	{
		ThisStdCall(0x61F170, this, onEnd, actor);
	}
...
class BSString {
public:
	bool Set(const char* src) { return ThisStdCall(0x004037F0, this, src, 0); }
...
public:
	...
	{
		return ThisStdCall<bool>(0x60D510, this, stageID);
	}
...
public:
	...
	{
		return ThisStdCall<bool>(0x981990, this);
	}
...
public:
	...
	__forceinline void Prepend(TESForm* toAdd) { ThisStdCall(0x590010, this, toAdd); }
...
struct FormBufferHeader
{
	...
	{
		return ThisStdCall<UInt32>(0x853500, this);
	}
};
...
public:
	...
	{
		ThisStdCall(0x865CE0, this, source, size, chunkConsumed, 0);
	}

	__forceinline static void EncodeRefID(UInt32* pRefID)
	{
		ThisStdCall(0x853570, pRefID, *pRefID);
	}

	inline void __fastcall WriteRefID(UInt32 refID)
	{
		UInt32 encoded = 0;
		ThisStdCall(0x853570, &encoded, refID);
		ThisStdCall(0x865CE0, this, &encoded, 4, chunkConsumed, 0);
	}
...
public:
	...
	{
		return ThisStdCall(0x861780, this, pForm);
	}
};
...
struct ScriptLocals
{
	...
	__forceinline void Destroy() { ThisStdCall(0x41AF70, this, 1); }
};
...
namespace Pointers {
	...
	namespace Functions {
		...
		static bool(__cdecl* ExtractArgs)(CommandParam*, void*, UInt32*, TESObjectREFR*, TESObjectREFR*, Script*, ScriptLocals*, ...) = (bool(__cdecl*)(CommandParam*, void*, UInt32*, TESObjectREFR*, TESObjectREFR*, Script*, ScriptLocals*, ...))0x005ACCB0;
