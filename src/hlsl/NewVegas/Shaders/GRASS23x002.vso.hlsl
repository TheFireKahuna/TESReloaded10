float3         DiffuseDir       : register(c0);    // c0
float3         DiffuseColor     : register(c1);    // c1
float3         ScaleMask        : register(c2);    // c2
float4         WindData         : register(c4);    // c4
float4         AlphaParam       : register(c5);    // c5
float4         AmbientColor     : register(c6);    // c6
float4         AddlParams       : register(c7);    // c7
row_major float4x4 ModelViewProj : register(c9);   // c9-c12
float4         FogColor         : register(c14);   // c14
float4         FogParam         : register(c15);   // c15
float4         InstanceData[2]  : register(c20);   // c20-c21
...
VS_OUTPUT main(VS_INPUT IN)
{
    ...
    // dp4 r2.w, c12, r1
    float4 r2;
    r2.x = dot(ModelViewProj[0], r1);
    r2.y = dot(ModelViewProj[1], r1);
    r2.z = dot(ModelViewProj[2], r1);
    r2.w = dot(ModelViewProj[3], r1);
    ...
    r2.xyz = r1.zzx * c16.xyz;

    // mad r3, r1.zzyw, c16.yxzw, -r2
    r3.xyz = (r1.zzy * c16.yxz) + (-r2.xyz);
    ...
    r1.y = InstanceData[a0].y + InstanceData[a0].x;
    ...
    // dp4 r0.y, c10, r2
    // dp4 r0.z, c11, r2
    r0.x = dot(ModelViewProj[0], r2);
    r0.y = dot(ModelViewProj[1], r2);
    r0.z = dot(ModelViewProj[2], r2);
    // OG: dp3 r0.w, r0, r0
