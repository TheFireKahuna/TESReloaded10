...
VS_OUTPUT main(VS_INPUT IN) {
    ...
    float4 blurOffset0 = tex2D(ScreenSpace, (BlurScale.xy * BlurOffsets[15].xy) + IN.ScreenOffset);
    ...
    OUT.color_0.rgb = (BlurOffsets[15].b * blurOffset0.rgb) + ((BlurOffsets[14].b * blurOffset15.rgb) + finalColor.rgb);
