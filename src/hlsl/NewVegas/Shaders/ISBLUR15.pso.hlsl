...
VS_OUTPUT main(VS_INPUT IN) {
    ...
    finalColor += (BlurOffsets[6].z * blurOffset7.rgb) + (BlurOffsets[5].z * blurOffset6.rgb);
    finalColor += (BlurOffsets[8].z * blurOffset9.rgb) + (BlurOffsets[7].z * blurOffset8.rgb);
    finalColor += (BlurOffsets[10].z * blurOffset11.rgb) + (BlurOffsets[9].z * blurOffset10.rgb);
    finalColor += (BlurOffsets[12].z * blurOffset13.rgb) + (BlurOffsets[11].z * blurOffset12.rgb);
    finalColor += (BlurOffsets[14].z * blurOffset15.rgb) + (BlurOffsets[13].z * blurOffset14.rgb);
    OUT.color_0.a = BlurOffsets[14].a;
