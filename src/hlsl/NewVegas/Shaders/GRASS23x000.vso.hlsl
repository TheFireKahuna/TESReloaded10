...
VS_OUTPUT main(VS_INPUT IN) {
    ...
    instanceData.y = frac(((InstanceData[0 + IN.texcoord_1.x].y + InstanceData[0 + IN.texcoord_1.x].x) / 128) + WindData.w);	// [0,1] to [-PI,PI]
    ...
    float4 ambientColor = AmbientColor * TESR_PBRData.w;
