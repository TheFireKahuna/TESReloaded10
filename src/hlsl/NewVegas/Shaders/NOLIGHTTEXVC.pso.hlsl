...
VS_OUTPUT main(VS_INPUT IN) {
    ...
    baseColor *= color;			// partial precision
    ...
    OUT.color_0.rgb = lerp(blendColorC, (saturate(IN.DiffuseUV.w * 1.5) * (1.0 - (materialColor.rgb * baseColor.rgb))) + blendColorA.rgb, Toggles.y);			// partial precision
